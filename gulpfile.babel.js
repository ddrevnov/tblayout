// generated on 2015-08-02 using generator-gulp-webapp 1.0.2
...
gulp.task('serve', ['svgmin', 'iconfont', 'sprite', 'views', 'styles', 'fonts'], () => {
  browserSync({
    notify: false,
    port: 9000,
    server: {
  ...
  gulp.watch('app/images/svg/*.svg', ['svgmin']);
...
gulp.task('build', ['html', 'svgmin', 'iconfont', 'sprite', 'images', 'fonts', 'extras'], () => {
